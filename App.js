...
const dS = StyleSheet.create({
  ...
  photoBottomOverlay: { position: 'absolute', left: 0, right: 0, bottom: 0, height: 60, backgroundColor: 'rgba(0,0,0,0.25)', justifyContent: 'flex-end', padding: 10 },
  overlayCourse:      { fontFamily: F.sys, fontSize: 13, color: '#fff', fontWeight: '600', textShadowColor: 'rgba(0,0,0,0.8)', textShadowOffset: { width: 0, height: 1 }, textShadowRadius: 4 },
  overlayDate:        { fontFamily: F.sys, fontSize: 10, color: 'rgba(255,255,255,0.7)', marginTop: 2, textShadowColor: 'rgba(0,0,0,0.8)', textShadowOffset: { width: 0, height: 1 }, textShadowRadius: 3 },
