...
const homeS = StyleSheet.create({
  ...
  memoCard:        { marginHorizontal: 20, backgroundColor: 'rgba(255,255,255,0.07)', borderWidth: 0.5, borderColor: 'rgba(255,255,255,0.12)', borderRadius: 12, padding: 14 },
  memoCardFirst:   { borderColor: 'rgba(200,217,230,0.2)', backgroundColor: 'rgba(200,217,230,0.06)' },
  memoEye:         { fontFamily: F.sys, fontSize: 8, color: 'rgba(255,255,255,0.28)', letterSpacing: 2, marginBottom: 6 },
  memoTxt:         { fontFamily: F.en, fontSize: 12, color: 'rgba(255,255,255,0.75)', fontStyle: 'italic', lineHeight: 18 },
  memoDate:        { fontFamily: F.sys, fontSize: 9, color: 'rgba(255,255,255,0.22)', marginTop: 6 },
...
const tabS = StyleSheet.create({
  bar:              { backgroundColor: C.bgPrimary, borderTopWidth: 0.5, borderTopColor: C.hairline, paddingBottom: 20 },
  stripeRow:        { flexDirection: 'row', height: 3 },
  stripeSegment:    { flex: 1, opacity: 0.35 },
  stripeSegmentOn:  { opacity: 1, height: 5, marginTop: -2 },
  tabRow:           { flexDirection: 'row', paddingTop: 6 },
  tab:              { flex: 1, alignItems: 'center', paddingTop: 4 },
  label:            { fontFamily: F.sys, fontSize: 11, marginTop: 1 },
  labelOn:          { color: C.charcoal, fontWeight: '600' },
  labelOff:         { color: C.warmGrayLight },
});
