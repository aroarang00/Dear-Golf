...
export const COURSE_TAGS = {
  ...
  '코스 특성':   ['그린 빠름', '그린 보통', '그린 느림', '넓은 페어웨이', '좁은 페어웨이', '전장 길음', '전장 짧음', '잔디 티박스', '매트 티박스'],
  '시설 · 운영': ['진행 원활', '진행 밀림', '클하 맛집', '세차 가능', '락커 좋음'],
  '경관 · 특징': ['뷰 좋음', '야간 가능'],
  '난이도':      ['벙커 많음', '언듈레이션 심함', 'OB 많음', '워터헤저드 많음'],
  '해외 특화':   ['오션뷰', '마운틴뷰', '리조트형', '열대코스', '링크스형', '챔피언십코스'],
};

// 서로 모순되는 태그 — 한쪽 선택 시 나머지 자동 해제(같은 카테고리라도 다른 속성은 공존 가능).
// 값은 배열(그린 빠름/보통/느림처럼 3자 배타 지원). COURSE_TAGS와 함께 관리(태그 추가/변경 시 여기도 동기화).
export const COURSE_TAG_OPPOSITES = {
  '그린 빠름': ['그린 보통', '그린 느림'],
  '그린 보통': ['그린 빠름', '그린 느림'],
  '그린 느림': ['그린 빠름', '그린 보통'],
  '넓은 페어웨이': ['좁은 페어웨이'], '좁은 페어웨이': ['넓은 페어웨이'],
  '전장 길음': ['전장 짧음'], '전장 짧음': ['전장 길음'],
  '진행 원활': ['진행 밀림'], '진행 밀림': ['진행 원활'],
  '잔디 티박스': ['매트 티박스'], '매트 티박스': ['잔디 티박스'],
};

export const COURSE_TAG_COLORS = {
  '코스 관리':   { bg: '#3D3935', text: '#F5E6A8' },
  '코스 특성':   { bg: '#F5E6A8', text: '#5A4500' },
  '시설 · 운영': { bg: '#C8D9E6', text: '#1A3D52' },
