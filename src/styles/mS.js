...
export const mS = StyleSheet.create({
  ...
  title:       { fontFamily: F.en, fontSize: 20, color: C.charcoal, marginBottom: 4 },
  ...
  specialBoxTitle: { fontFamily: F.en, fontSize: 14, color: '#8B6914', letterSpacing: 2, marginBottom: 4 },
