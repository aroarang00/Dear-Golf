...
export const mS = StyleSheet.create({
  ...
  label:       { fontFamily: F.sys, fontSize: fs(10), color: C.warmGrayLight, letterSpacing: 1.5, marginTop: 14, marginBottom: 6 },
  ...
  chipTxt:     { fontFamily: F.sys, fontSize: fs(12), color: C.warmGrayLight },
