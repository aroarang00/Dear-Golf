...
export const obS = StyleSheet.create({
  stepLabel:  { fontFamily: F.sys, fontSize: fs(10), color: C.warmGray, letterSpacing: 2, marginBottom: 20 },
  label:      { fontFamily: F.sys, fontSize: fs(10), color: C.warmGray, letterSpacing: 1.5, marginTop: 16, marginBottom: 6 },
