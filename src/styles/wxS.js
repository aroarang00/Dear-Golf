...
export const wxS = StyleSheet.create({
  ...
  backArrow:     { fontSize: fs(22), color: 'rgba(255,255,255,0.45)' },
  ...
  pillTxtOn:     { fontFamily: F.sysSb, fontSize: fs(12), color: '#F5E6A8' },
  pillTxtOff:    { fontFamily: F.sys, fontSize: fs(12), color: 'rgba(255,255,255,0.4)' },

  // 섹션 레이블 ("라운딩 컨디션", "10일 예보" 등)
  sectionLabel:  { fontFamily: F.sysSb, fontSize: fs(14), color: 'rgba(255,255,255,0.85)', letterSpacing: 0.5, marginBottom: 12 },

  // ① 구장명 + 날짜
  wxHeader:      { paddingHorizontal: 20, paddingTop: 8, paddingBottom: 16 },
  wxCourse:      { fontFamily: F.sysSb, fontSize: fs(20), color: '#fff', marginBottom: 4 },
  wxDate:        { fontFamily: F.sys, fontSize: fs(11), color: 'rgba(255,255,255,0.4)' },

  // ② 기온 히어로
  tempHero:      { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 20, paddingTop: 8, paddingBottom: 24 },
  tempEmoji:     { fontSize: fs(44), marginRight: 10 },
  ...
  gridLabel:     { fontFamily: F.sys, fontSize: fs(11), color: 'rgba(255,255,255,0.6)', letterSpacing: 0.5, marginBottom: 6 },
  gridValue:     { fontFamily: F.sysSb, fontSize: fs(13), color: '#fff' },
  gridSub:       { fontFamily: F.sys, fontSize: fs(11), color: 'rgba(255,255,255,0.55)', marginTop: 4 },
  ...
  gIdxBig:       { fontFamily: F.en, fontSize: fs(28), fontStyle: 'italic', color: '#F5E6A8' },
  ...
  condLabel:     { marginLeft: 'auto', fontFamily: F.sys, fontSize: fs(11), color: 'rgba(255,255,255,0.55)' },
  teeBadge:      { marginLeft: 8, paddingHorizontal: 6, paddingVertical: 2, backgroundColor: 'rgba(107,30,42,0.7)', borderRadius: 4 },
  teeBadgeTxt:   { fontFamily: F.sysSb, fontSize: fs(11), color: '#F5E6A8' },
  ...
  fcDayBox:      { width: 56 },
  fcDay:         { fontFamily: F.sysM, fontSize: fs(13), color: 'rgba(255,255,255,0.85)' },
  fcDayToday:    { fontFamily: F.sysB, color: '#F5E6A8' },
  fcDate:        { fontFamily: F.sys, fontSize: fs(11), color: 'rgba(255,255,255,0.55)', marginTop: 1 },
  fcIcon:        { fontSize: fs(20), marginRight: 8 },
  fcMain:        { flex: 1 },
  fcSkyRow:      { flexDirection: 'row', alignItems: 'center', flexWrap: 'wrap', gap: 6 },
  fcSky:         { fontFamily: F.sys, fontSize: fs(12), color: '#fff' },
  fcSub:         { fontFamily: F.sys, fontSize: fs(11), color: 'rgba(255,255,255,0.6)', marginTop: 2 },
  fcTempMin:     { fontFamily: F.sys, fontSize: fs(12), color: 'rgba(255,255,255,0.5)' },
  fcTempMax:     { fontFamily: F.sysSb, fontSize: fs(12), color: '#fff' },
  roundBadge:    { paddingHorizontal: 6, paddingVertical: 2, backgroundColor: '#6B1E2A', borderRadius: 4 },
  roundBadgeTxt: { fontFamily: F.sysSb, fontSize: fs(11), color: '#F5E6A8' },
  ...
  naverBtnTxt:   { fontFamily: F.sysM, fontSize: fs(13), color: '#03C75A' },
