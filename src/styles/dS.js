...
export const dS = StyleSheet.create({
  ...
  detailCourseTxt: { fontFamily: F.sys, fontSize: fs(12), color: C.warmGray, marginBottom: 12 },
  ...
  companionLabel:      { fontFamily: F.sys, fontSize: fs(10), color: C.warmGray, letterSpacing: 1, marginTop: 9 },
  ...
  photosLabel:     { fontFamily: F.sys, fontSize: fs(10), color: C.warmGray, letterSpacing: 1.5 },
