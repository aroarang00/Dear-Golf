...
export const dS = StyleSheet.create({
  ...
  tabTxt:      { fontFamily: F.sys, fontSize: fs(13), color: C.warmGrayLight },
  ...
  filterTabTxt:      { fontFamily: F.sys, fontSize: fs(11), color: '#8B8680' },
  ...
  emptyMsg:    { fontFamily: F.sys, fontSize: fs(13), color: C.warmGrayLight },
  ...
  specialNoPhotoTxt: { fontFamily: F.en, fontSize: fs(16), color: '#8B6914', fontStyle: 'italic', letterSpacing: 2 },
  specialNoPhotoSub: { fontFamily: F.sys, fontSize: fs(11), color: '#B8A878', marginTop: 4 },
  hofSectionLabel: { fontFamily: F.sys, fontSize: fs(10), color: '#C9A84C', letterSpacing: 3 },
  ...
  hofCellVal:  { fontFamily: F.sys, fontSize: fs(10), color: '#3D3935', lineHeight: 15 },
  ...
  specialBannerTitle: { fontFamily: F.en, fontSize: fs(34), color: '#C9A84C', fontStyle: 'italic', letterSpacing: 5, marginVertical: 6 },
  specialBannerSub:   { fontFamily: F.sys, fontSize: fs(9), color: 'rgba(201,168,76,0.6)', letterSpacing: 4 },
  ...
  cardBody:    { padding: 12 },
  cardDate:    { fontFamily: F.sys, fontSize: fs(10), color: C.warmGrayLight, marginBottom: 4 },
  ...
  cardPar:     { fontFamily: F.sys, fontSize: fs(10), color: C.warmGrayLight, marginTop: 2 },
  ...
  backBtn:        { fontFamily: F.sys, fontSize: fs(13), color: C.warmGrayLight },
  ...
  detailScoreSub:  { fontFamily: F.sys, fontSize: fs(12), color: C.warmGrayLight },
  detailCourseTxt: { fontFamily: F.sys, fontSize: fs(12), color: C.warmGrayLight, marginBottom: 12 },
  ...
  companionLabel:      { fontFamily: F.sys, fontSize: fs(10), color: C.warmGrayLight, letterSpacing: 1, marginTop: 9 },
  ...
  compNames:           { fontFamily: F.sys, fontSize: fs(11), color: '#8B8680', flex: 1 },
  photosArea:      { padding: 16 },
  photosLabel:     { fontFamily: F.sys, fontSize: fs(10), color: C.warmGrayLight, letterSpacing: 1.5 },
  ...
  courseLoc:   { fontFamily: F.sys, fontSize: fs(11), color: C.warmGrayLight, marginBottom: 8 },
  ...
  recLblDark:  { fontFamily: F.sys, fontSize: fs(9), color: C.warmGrayLight, marginTop: 2 },
