...
export const dS = StyleSheet.create({
  ...
  hofMemo:     { fontFamily: F.en, fontSize: 11, color: '#6B6660', padding: 14, lineHeight: 18 },
  ...
  detailMemoTxt:   { fontFamily: F.en, fontSize: 14, color: C.textPrimary, lineHeight: 22 },
  ...
  courseMemo:  { fontFamily: F.en, fontSize: 11, color: C.textSecondary, borderLeftWidth: 1.5, borderLeftColor: C.burgundy, paddingLeft: 8 },
});
