...
export const gS = StyleSheet.create({
  searchTxt:       { fontFamily: F.en, fontSize: 15, color: C.charcoal, borderBottomWidth: 0.5, borderBottomColor: C.charcoal, paddingBottom: 1 },
  ...
  detailName:      { fontFamily: F.en, fontSize: 18, color: C.charcoal, marginBottom: 2 },
  ...
  memoTxt:         { fontFamily: F.en, fontSize: 12, color: C.textSecondary, lineHeight: 18 },
  ...
  restMemo:        { fontFamily: F.en, fontSize: 10, color: C.textSecondary, marginTop: 3 },
