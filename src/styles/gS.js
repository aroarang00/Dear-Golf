...
export const gS = StyleSheet.create({
  ...
  courseCardLoc:   { fontFamily: F.sys, fontSize: fs(11), color: C.warmGrayLight, marginBottom: 8 },
  courseCardScore: { fontFamily: F.sys, fontSize: fs(11), color: C.burgundy },
  courseCardArrow: { fontFamily: F.en, fontSize: fs(18), color: C.warmGrayLight },
  detailHdr:       { backgroundColor: C.bgPrimary, paddingHorizontal: 16, paddingTop: 12, paddingBottom: 0 },
  backBtn:         { fontFamily: F.sys, fontSize: fs(11), color: C.warmGrayLight, marginBottom: 6 },
  detailName:      { fontFamily: F.en, fontSize: fs(18), color: C.charcoal, marginBottom: 2 },
  detailLoc:       { fontFamily: F.sys, fontSize: fs(11), color: C.warmGrayLight, marginBottom: 10 },
  ...
  innerTabTxt:     { fontFamily: F.sys, fontSize: fs(12), color: C.warmGrayLight },
  ...
  infoKey:         { fontFamily: F.sys, fontSize: fs(12), color: C.warmGrayLight },
  ...
  restType:        { fontFamily: F.sys, fontSize: fs(10), color: C.warmGrayLight },
  ...
  commentWho:      { fontFamily: F.sys, fontSize: fs(10), color: C.warmGrayLight },
  commentAddBtn:   { borderWidth: 0.5, borderColor: C.hairline, borderRadius: 10, padding: 12, alignItems: 'center', marginTop: 4 },
  commentAddTxt:   { fontFamily: F.sys, fontSize: fs(12), color: C.warmGrayLight },
  ...
  nearbyLoc:       { fontFamily: F.sys, fontSize: fs(10), color: C.warmGrayLight, marginTop: 2 },
  ...
  emptySub:        { fontFamily: F.sys, fontSize: fs(12), color: C.warmGrayLight, textAlign: 'center', lineHeight: 18 },
});
