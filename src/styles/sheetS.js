...
export const sheetS = StyleSheet.create({
  ...
  course:      { fontFamily: F.sysSb, fontSize: fs(19), color: C.charcoal },
  courseArrow: { fontSize: fs(15), color: C.warmGray, fontWeight: '400' },
  meta:        { fontFamily: F.sysM, fontSize: fs(13), color: C.textSecondary, marginTop: 6 },
  dday:        { fontFamily: F.en, fontSize: fs(38), color: C.burgundy, letterSpacing: -0.5, lineHeight: 40 },
  ddayLabel:   { fontFamily: F.sysM, fontSize: fs(13), color: C.charcoal },
  ...
  rowText:     { fontFamily: F.sysSb, fontSize: fs(16), color: C.charcoal },
