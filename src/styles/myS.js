...
export const myS = StyleSheet.create({
  ...
  realName:     { fontFamily: F.sys, fontSize: fs(11), color: C.warmGrayLight, marginTop: 4 },
  ...
  sectionLabel: { fontFamily: F.sys, fontSize: fs(10), color: C.warmGrayLight, letterSpacing: 2, marginBottom: 12 },
  ...
  statLabel:    { fontFamily: F.sys, fontSize: fs(10), color: C.warmGrayLight, marginTop: 2 },
  ...
  menuValue:    { fontFamily: F.sys, fontSize: fs(12), color: C.warmGrayLight },
});
