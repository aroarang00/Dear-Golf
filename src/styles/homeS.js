...
export const homeS = StyleSheet.create({
  ...
  mainCard:        { width: isAndroid ? 210 : 232, height: isAndroid ? 208 : 234, backgroundColor: 'rgba(255,255,255,0.09)', borderWidth: 0.5, borderColor: 'rgba(255,255,255,0.18)', borderRadius: 16, padding: isAndroid ? 13 : 16 },
  ...
  cardDDay:        { fontFamily: F.en, fontSize: isAndroid ? fs(58) : fs(66), color: C.butter, lineHeight: isAndroid ? 62 : 70, letterSpacing: -1, includeFontPadding: false },
  subCard:         { width: isAndroid ? 100 : 110, height: isAndroid ? 208 : 234, backgroundColor: 'rgba(255,255,255,0.05)', borderWidth: 0.5, borderColor: 'rgba(255,255,255,0.1)', borderRadius: 14, padding: isAndroid ? 11 : 12, justifyContent: 'space-between' },
