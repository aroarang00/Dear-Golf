...
export const homeS = StyleSheet.create({
  ...
  cardCourse:      { fontFamily: F.sysB, fontSize: fs(15), color: '#fff', marginBottom: 6, lineHeight: 20, textShadowColor: 'rgba(0,0,0,0.6)', textShadowOffset: { width: 0, height: 1 }, textShadowRadius: 4 },
