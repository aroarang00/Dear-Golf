...
export const homeS = StyleSheet.create({
  ...
  hdrTitle:        { fontFamily: F.en, fontSize: 40, lineHeight: 54, color: '#fff', fontStyle: 'italic', marginBottom: 6, textShadowColor: 'rgba(0,0,0,0.5)', textShadowOffset: { width: 0, height: 2 }, textShadowRadius: 8 },
