...
export const homeS = StyleSheet.create({
  ...
  cardCourse:      { fontFamily: F.sys, fontSize: fs(15), color: '#fff', marginBottom: 6, lineHeight: 20, textShadowColor: 'rgba(0,0,0,0.6)', textShadowOffset: { width: 0, height: 1 }, textShadowRadius: 4 },
  cardDate:        { fontFamily: F.sys, fontSize: fs(11), color: 'rgba(255,255,255,0.5)' },
  ...
  subCourse:       { fontFamily: F.sys, fontSize: fs(11), color: '#fff', lineHeight: 15 },
  subDate:         { fontFamily: F.sys, fontSize: fs(9), color: 'rgba(255,255,255,0.4)', marginTop: 3 },
  ...
  memoSub:         { fontFamily: F.sys, fontSize: fs(11), color: 'rgba(255,255,255,0.35)' },
