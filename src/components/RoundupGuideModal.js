...
const SECTIONS = [
  ...
  {
    icon: '🤝', title: '취소 · 노쇼',
    body: '함께하는 골프는 서로의 시간을 아껴주는 마음에서 시작돼요.\n\n— 취소 —\n• 라운딩 7일 이전 — 자유롭게 취소할 수 있어요\n• 라운딩 7일 이내 — 취소는 언제든 가능하지만 매너 평가에 영향이 있을 수 있어요\n  부득이한 사정이 생기면 모집 내 댓글로 동반자들과 소통해주세요\n\n주최자는 우천·천재지변 같은 사유로 모집을 취소할 수 있어요.\n골프장 위약금은 본인 부담이에요 (Dear Golf는 정산에 관여하지 않아요).\n\n— 노쇼 —\n티오프 시각이 지나도록 사전 안내 없이 나타나지 않으면 노쇼로 신고받을 수 있어요.\n\n• 노쇼 확정 — 60일 모집·참여 정지 + 매너 등급 큰 폭 하락\n• 2회 누적 — 영구 정지 (12개월 시점 카운트 자동 -1)\n\n신고가 접수되면 7일 동안 당사자끼리 해결할 시간이 있어요.\n신고자가 자율 취소하면 종결되고, 7일이 지나면 자동 확정되어 48시간 안에 소명을 제출할 수 있어요.\n\n소명이 명확하면 신고자가 오히려 허위신고 패널티(90일 정지)를 받아요.',
  },
  {
    icon: '😊', title: '매너 등급',
