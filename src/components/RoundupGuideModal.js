...
const SECTIONS = [
  {
    icon: '🤝', title: '신뢰로 모이는 라운지',
    body: '라운지의 모든 모집은\n서로 아는 사이에서 시작돼요.\n\n모집 주최자는 언제나 내 친구예요.\n모르는 사람의 모집은 보이지 않아요.\n\n따로 검증할 필요 없이,\n친구라는 신뢰로 모임이 운영돼요.\nDear Golf는 모임의 장(場) 역할만 해요.',
  },
  {
    icon: '📋', title: '모집 종류 · 공개 범위',
  ...
  {
    icon: '✨', title: '준비 중인 기능',
    body: '더 편하게 기록할 수 있도록\n준비하고 있어요.\n\n• 동반자 자동 입력\n  함께한 동반자가\n  라운딩 기록에 자동으로 채워져요.\n\n• 스코어 한 번에\n  라운딩 후 동반자 한 명이\n  스코어카드를 공유하면,\n  그중 내 점수만 골라\n  내 기록으로 바로 등록할 수 있어요.\n\n(아직 준비 중이라 곧 만나보실 수 있어요.)',
  },
  {
    icon: '🤝', title: '취소 · 노쇼는 배려로',
          ...
          <ScrollView style={{ flexShrink: 1 }}
            ...
            {SECTIONS.map(s => (
              <View key={s.title} style={{ marginBottom: 18 }}>
                ...
                <Text style={{ fontFamily: F.sys, fontSize: fs(13), color: C.warmGray, lineHeight: 21 }}>{s.body}</Text>
              </View>
            ))}
          </ScrollView>
