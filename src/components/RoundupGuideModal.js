...
const SECTIONS = [
  ...
  {
    icon: '✋', title: '참여 방법',
    body: '전체공개 모집 — 참여 신청 → 주최자 수락 → 확정. 주최자가 신청자의 신뢰 등급·매너 등급을 보고 수락 여부를 정해요.\n친구공개·친구지정 모집 — 바로 참여가 확정돼요.',
  },
  {
    icon: '⏳', title: '대기',
  ...
  {
    icon: '😊', title: '매너 등급',
    body: '4단계로 표시돼요 — 매너왕 / 좋음 / 보통 (신규 시작) / 주의.\n동반자들이 라운딩 후 남긴 평가가 쌓이면서 등급이 천천히 변해요. 사용자에게는 등급 라벨로만 보여요.\n\n친구공개·친구지정 모집은 매너 평가를 받지 않아요 (이미 아는 사이라 평가가 부담스러우니까요). 전체공개 모집에서만 평가가 진행돼요.',
  },
  {
    icon: '🛡️', title: '신뢰 등급',
