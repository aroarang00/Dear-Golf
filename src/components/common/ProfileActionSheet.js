      ...
      <TouchableOpacity style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0.4)' }} activeOpacity={1} onPress={onClose}>
        <View style={{ flex: 1, justifyContent: 'flex-end' }}>
          <TouchableOpacity activeOpacity={1} onPress={() => {}}
            ...
            {isMe ? (
              <Text style={{ fontFamily: F.sys, fontSize: 13, color: C.warmGray,
              ...
              <View style={{ flexDirection: 'row', gap: 10 }}>
                <TouchableOpacity onPress={() => { onClose(); onReport?.(target); }} activeOpacity={0.85}
                  ...
                  <Text style={{ fontFamily: F.sys, fontSize: 14, color: C.charcoal, fontWeight: '700' }}>🚨 신고</Text>
                </TouchableOpacity>
                <TouchableOpacity onPress={() => { onClose(); onBlock?.(target); }} activeOpacity={0.85}
                  ...
                  <Text style={{ fontFamily: F.sys, fontSize: 14, color: '#8B2A2A', fontWeight: '700' }}>🚫 차단</Text>
                </TouchableOpacity>
              </View>
            )}
            <TouchableOpacity onPress={onClose} activeOpacity={0.7}
              style={{ marginTop: 10, paddingVertical: 10, alignItems: 'center' }}>
              <Text style={{ fontFamily: F.sys, fontSize: 13, color: C.warmGray, fontWeight: '600' }}>닫기</Text>
            </TouchableOpacity>
          </TouchableOpacity>
        </View>
      </TouchableOpacity>
